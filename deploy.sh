...
# main config
PLUGINSLUG="the-events-calendar-user-css"
CURRENTDIR=`pwd`
MAINFILE="the-events-calendar-user-css.php" # this should be the name of your main php file in the wordpress plugin
